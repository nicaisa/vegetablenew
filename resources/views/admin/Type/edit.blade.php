        ...
        <div class="panel-body ">
          <div class="ro">
            <div class="col-mol-md-offset-2">
              ...
              <form class="form-horizontal cascade-forms" action="{{route('uptype')}}" method="post"  name="signup_form">
              ...
              <label class="col-lg-2 col-md-3 control-label">商品类型名称：</label>
                <div class="col-lg-10 col-md-9">
                  <input type="text"  name="name"   value="{{$data->name}}" required placeholder="请在这里输入商品类型名" class="form-control form-cascade-control input-small"/>
