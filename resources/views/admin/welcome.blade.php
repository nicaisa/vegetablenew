...
<title>系统发展历程</title>
<link rel="stylesheet" type="text/css" href="{{asset('style/welcome/css/reset_y.css')}}">
<style>
body {
	...
	_background:#fff url("{{asset('style/welcome/images/bg01.jpg')}}") no-repeat;
...
.impress-supported .bg {
	...
	left: 0;
	z-index: -100;
	background:#fff url("{{asset('style/welcome/images/bg04.jpg')}}") no-repeat;
...
<script id="jquery_183" type="text/javascript" class="library" src="{{asset('style/welcome/js/jquery-1.8.3.min.js')}}"></script>
<script> 
   (function() {
     if (! 
     /*@cc_on!@*/
...
<div class="bg"><img src="{{asset('style/welcome/images/bg04.jpg')}}" width="100%"/></div>

<header class="top" id="top">
	<h1><a href="http://www.lanrenzhijia.com/"><img src="{{asset('style/welcome/images/160_os_logo.png')}}" alt="好好吃"/></a><em>2018大记事</em></h1>
	...
	<div id="impress">
		<div id="timeList">
			<div class="step year" data-x="-600" data-y="0" data-scale ="0.5" id="0">
				<div class="year2012">01.05</div>
				<div class="list_show">01.05日<br/></div>
			</div>
			<div class="timeList_item step" data-x="0" data-y="0" id="1">
				<div class="circle">01/05</div>
				<h2 class="timeList_item_title">全面开启生鲜网开发之旅</h2>
				<div class="list_show show1" >
					<img src="{{asset('style/welcome/images/event1.jpg')}}" width="500">
					<h2><a href="#">全面开启生鲜网开发之旅</a></h2>
					<p>让你不用在饱受出门没有时间购买蔬菜等生活必须品，静静的等待宝贝的到来。</p>
				</div>
			</div>
			<div class="timeList_item step"  data-x="200" data-y="0" id="2">
				<div class="circle">01/10</div>
				<h2 class="timeList_item_title">写项目需求分析书</h2>
				<div class="list_show">
					<img src="{{asset('style/welcome/images/event2.jpg')}}">
					<h2><a href="#">全方位分析客户需求</a></h2>
					<p class="m160">写项目需求<br/>多种方案，择优选取<br/>撰写开题报告、准备开题</p>
				</div>
			</div>
			<div class="timeList_item step" data-x="400" data-y="0" id="3">
				<div class="circle">03/09</div>
				<h2 class="timeList_item_title">项目开题答辩</h2>
				<div class="list_show">
					<img src="{{asset('style/welcome/images/event3.png')}}" width="500">
					<h2><a href="#">项目答辩通过审核</a></h2>
					<p>完成系统开发初期之旅</p>
				</div>
			</div>
			<div class="timeList_item step" data-x="600" data-y="0" id="4">
				<div class="circle">03/10</div>
				<h2 class="timeList_item_title">正式启动项目实战阶段</h2>
				<div class="list_show show3">
					<img src="{{asset('style/welcome/images/event4.jpg')}}" width="500">
					<h2><a href="#">app实战阶段</a></h2>
					<p>系统总体设计，收集相关资料</p>
				</div>
			</div>
			{{--第一阶段：开题准备，接收任务，理解消化，分别从技术角度和业务角度准备相关知识、查看相关资料，撰写开题报告、准备开题；
第二阶段：开题；
第三阶段：需求获取、分析，系统总体设计，毕业设计第一次工作汇报；
第四阶段：系统详细功能设计，系统页面设计，系统数据库设计，毕业设计第二次工作汇报；
第五阶段：系统编码实现及功能模块测试，毕业设计中期检查；
第六阶段：系统测试；
第七阶段：论文撰写，毕业设计第三次工作汇报；
第八阶段：论文定稿、查重、准备答辩；
第九阶段：论文答辩，论文装订、资料整理、提交及归档。
--}}
			<div class="timeList_item step" data-x="600" data-y="0" id="4">
				<div class="circle">03/11</div>
				<h2 class="timeList_item_title">项</h2>
				<div class="list_show show3">
					<img src="{{asset('style/welcome/images/event4.jpg')}}" width="500">
					<h2><a href="#"></a></h2>
					<p>系统总体设计，收集相关资料</p>
			...
			<div class="timeList_item step" data-x="800" data-y="0" id="5">
				<div class="circle">03/12</div>
				<h2 class="timeList_item_title">项目页面设计、数据库设计</h2>
				<div class="list_show">
					<img src="{{asset('style/welcome/images/event5.png')}}" width="500">
					<h2><a href="#">设计项目的页面</a></h2>
					<p>开启系统页面设计，数据库设计开发</p>
				</div>
			</div>
			<div class="timeList_item step" data-x="1000" data-y="0" id="6">
				<div class="circle">03/13</div>
				<h2 class="timeList_item_title">系统后台开发</h2>
				<div class="list_show">
					<img src="{{asset('style/welcome/images/event6.png')}}" width="500">
					<h2><a href="#">系统后台开发之旅途</a></h2>
					<p>千呼万唤始出来 - 系统后台开发</p>
				</div>
			</div>
			<div class="timeList_item step" data-x="1200" data-y="0" id="7">
				<div class="circle">04/05</div>
				<h2 class="timeList_item_title">提交中期报告</h2>
				<div class="list_show show4">
					<img src="{{asset('style/welcome/images/event7.jpg')}}">
					<h2><a href="#">汇报项目进度</a></h2>
					<p><img src="{{asset('style/welcome/images/shenzhen.jpg')}}"/></p>
				</div>
			</div>
			<div class="timeList_item step" data-x="1400" data-y="0" id="8">
				<div class="circle">04/07</div>
				<h2 class="timeList_item_title">开启系统前台开发之旅</h2>
				<div class="list_show">
					<img src="{{asset('style/welcome/images/event8.jpg')}}" width="500">
					<h2><a href="#">show出我的风格</a></h2>
					<p>炎炎夏日已来，系统前台开发进入主题</p>
				</div>
			</div>
			<div class="timeList_item step" data-x="1600" data-y="0" id="9">
				<div class="circle">04/20</div>
				<h2 class="timeList_item_title">论文之旅</h2>
				<div class="list_show show3">
					<img src="{{asset('style/welcome/images/event9.jpg')}}" width="500">
					<h2><a href="#">编写文档，整理项目</a></h2>
					<p><img src="{{asset('style/welcome/images/beijing.jpg')}}" /></p>
				</div>
			</div>
			<div class="timeList_item step" data-x="1800" data-y="0"  id="10">
				<div class="circle">>04/26</div>
				<h2 class="timeList_item_title">系统测试</h2>
				<div class="list_show">
					<img src="{{asset('style/welcome/images/event10.jpg')}}" width="500">
					<h2><a href="#">测试系统</a></h2>
					<p class="m160"> 测试系统，解决bug</p>
				</div>
			</div>
			<div class="timeList_item step"  data-x="2000" data-y="0" id="11">
				<div class="circle">04/30</div>
				<h2 class="timeList_item_title">修改文档</h2>
				<div class="list_show show4">
					<img src="{{asset('style/welcome/images/event11.jpg')}}" width="500">
					<h2><a href="#">修改论文内容及格式</a></h2>
					<p><img src="{{asset('style/welcome/images/guangzhou.jpg')}}"/></p>
				</div>
			</div>
			<div class="timeList_item step" data-x="2200" data-y="0" id="12">
				<div class="circle">05/02</div>
				<h2 class="timeList_item_title">论文查重</h2>
				<div class="list_show">
					<img src="{{asset('style/welcome/images/event12.jpg')}}" width="500">
					<h2><a href="#">论文查重，修改论文</a></h2>
					<p><img src="{{asset('style/welcome/images/nanjing.jpg')}}" /></p>
				</div>
			</div>
			<div class="timeList_item step" data-x="2400" data-y="0" id="13">
				<div class="circle">05/05</div>
				<h2 class="timeList_item_title">答辩准备</h2>
				<div class="list_show">
					<img src="{{asset('style/welcome/images/event13.jpg')}}"  width="500">
					<h2><a href="#">准备答辩ppt</a></h2>
					<p>整理整体项目，项目重点放在ppt中</p>
				</div>
			</div>
			<div class="timeList_item step" data-x="2600" data-y="0" id="14">
				<div class="circle">05/11</div>
				<h2 class="timeList_item_title">项目答辩</h2>
				<div class="list_show">
					<img src="{{asset('style/welcome/images/event14.jpg')}}"  width="500">
					<h2><a href="#">项目答辩</a></h2>
					<p class="m160">ppt讲解，展示项目</p>
				</div>
			</div>
		</div>
	</div>
</section>
<div class="gotop"> <a href="#top"><img src="{{asset('style/welcome/images/top.png')}}" title="回顶部"/></a></div>

<script type="text/javascript" src="{{asset('style/welcome/js/impress.js')}}"></script>
...
//预加载图片
new Image().src = "{{asset('style/welcome/images/bg04.jpg')}}";
new Image().src = "{{asset('style/welcome/images/bg01.jpg')}}";
new Image().src = "{{asset('style/welcome/images/bg02.jpg')}}";
new Image().src = "{{asset('style/welcome/images/bg03.jpg')}}";
...
$(function(){			
	...
	// if(!$.browser.msie){
	// 	if($.browser.safari)
	// 		bgMusic = new Audio("{{asset('style/welcome/music/music.mp3')}}");
	// 	else
	// 		bgMusic = new Audio("{{asset('style/welcome/music/music.ogg')}}");
	// 	bgMusic.loop = true;
	// 	bgMusic.volume = 0.7;
...
var changeBackground = function(month){
	...
	if(month == 12 || month == 1 || month==2){
		if(last_month==4)
			return;
		last_month = 4;
		url = "{{asset('style/welcome/images/bg04.jpg')}}";
		...
		if(last_month==1)
			return;
		last_month = 1;
		url = "{{asset('style/welcome/images/bg01.jpg')}}";
		$("header").css("background-color","rgba(255,255,255,0.2)");
		...
		if(last_month==2)
			return;
		last_month = 2;
		url ="{{asset('style/welcome/images/bg02.jpg')}}";
		...
		if(last_month==3)
			return;
		last_month = 3;
		url ="{{asset('style/welcome/images/bg03.jpg')}}";
		$("header").css("background-color","rgba(255,255,255,0.2)");
