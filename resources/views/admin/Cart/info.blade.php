...
<body>
	<div class="container">
		<div class="row"><h3 class='text-primary'>个人信息 <a  href="{{route('user')}}" class='btn btn-sm btn-warning'>返回</button></h3></a>
		<div class="row">
		<h4 class='text-info'>详细资料</h4>
			<table class='table table-hover table-striped'>
				...
				<tr>
					<td  colspan="2">
						<img src="{{asset('style/admin/img/headimg/head.jpg')}}" > 
